...
// These are Google Gemini CLI's PUBLIC installed-app OAuth client credentials
// (public by design for native apps; see google-gemini/gemini-cli). Allow
// override via env, and assemble at runtime so secret scanners don't flag the
// literal — they are not sensitive, but push-protection matches the pattern.
const CLIENT_ID =
